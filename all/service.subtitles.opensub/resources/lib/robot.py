...
# Import uploader centralizat din lib (sau folderul curent)
try:
...
# Logica originala de Import chei backup
try:
...
def run_translation(sub_addon_id):
    ...
    # --- LOGICA ORIGINALA DE CHEI (api_key_r1_x) ---
    all_keys = []
    for i in range(1, 6):
    ...
    # Identificam fisierul original (cel care nu are prefix de robot)
    ...
    # --- NUME SI CALE (DEFINITE LA INCEPUT PENTRU A EVITA ERORI) ---
    ...
    try:
        ...
        for i in range(0, total, batch_size):
            ...
            while current_key_idx < len(all_keys):
                ...
                else: break # Eroare de conexiune sau altceva
            ...
            # Salvare disk si aplicare imediata
