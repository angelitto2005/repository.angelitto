...
def search():
    ...
    try:
        import system_core
        u, w, z = system_core.get_auth_pieces() # Luăm piesele decodate (blagoie, gmail, parola)
        
        if u and w and z:
            # Asamblarea ta originală
            ...
            with urllib.request.urlopen(req, timeout=10) as resp:
                ...
                for f in files:
                    ...
                    if f_clean.lower().endswith(('.srt', '.sub')) and f_target in f_clean.lower():
                        ...
                        # URL DINAMIC PENTRU DOWNLOAD (fără date scrise în clar)
...
def download(params):
    ...
    # Adăugăm calea către folderul 'resources/lib'
